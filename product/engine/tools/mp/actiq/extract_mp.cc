...
::mediapipe::Status RunMPPGraph() {
  ...
  std::string content;
  MP_RETURN_IF_ERROR(mediapipe::file::GetContents(
      "tools/mp-depends/inception3_mean_matrix_data.pb", &content));
  ...
  MP_RETURN_IF_ERROR(mediapipe::file::GetContents(
      "tools/mp-depends/inception3_projection_matrix_data.pb", &content));
  ...
  MP_RETURN_IF_ERROR(mediapipe::file::GetContents(
      "tools/mp-depends/vggish_mean_matrix_data.pb", &content));
  ...
  MP_RETURN_IF_ERROR(mediapipe::file::GetContents(
      "tools/mp-depends/vggish_projection_matrix_data.pb", &content));
